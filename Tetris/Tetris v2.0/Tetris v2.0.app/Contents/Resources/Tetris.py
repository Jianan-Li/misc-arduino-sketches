...
def drawCover(canvas):
    ...
    canvas.create_text(72,top+10, text="Move - arrow keys", font=("Helvetica", 14, "bold"),fill='black')
    canvas.create_text(69,top+24, text="Rotate - up arrow", font=("Helvetica", 14, "bold"),fill='black')
    canvas.create_text(59,top+38, text="Start/Pause - S", font=("Helvetica", 14, "bold"),fill='black')
    canvas.create_text(38,top+52, text="Reset - R", font=("Helvetica", 14, "bold"),fill='black')
    canvas.create_text(35,top+66, text="Quit - Q", font=("Helvetica", 14, "bold"),fill='black')
    # score
    ...
    canvas.create_text(200,top+24, text="Score:", font=("Helvetica", 18, "bold"),fill='black')
    canvas.create_text(248,top+24, text="%d" % (score), font=("Helvetica", 18, "bold"),fill='Black')
    canvas.create_text(177,top+54, text="High Score:", font=("Helvetica", 18, "bold"),fill='black')
    canvas.create_text(248,top+54, text="%d" % (highscore), font=("Helvetica", 18, "bold"),fill='Black')
    if canvas.data["isGameOver"] == True:
        drawGameOver(canvas)
    # ||
    if canvas.data['start/pause']==False and canvas.data["isGameOver"] == False and canvas.data['gameStarted']==True:
        canvas.create_text((left+right)/2, top-400, text="||", font=("Helvetica", 52, "bold"),fill='white')
...
def run(cols, rows):
    ...
    canvas.data['NumCheckonRotationOurOfBoundary']=0
